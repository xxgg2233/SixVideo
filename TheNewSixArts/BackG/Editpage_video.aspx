<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Editpage_video.aspx.cs" Inherits="BackG_Editpage_video" %>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="button" class="btn btn-default" value="编辑" onclick="setOpear(<%=dr["vId"]%>,2)" />
